        ...
        function H() {
            ...
            if (b.mode == "horizontal") {
                ...
                e.children(b.childSelector).css({
                    width: j,    /* Change the width of the slide box  */
                    "float": "left",
                    listStyle: "none"
                });
                h = e.parent().parent();
                ...
                e.wrap('<div class="' + b.wrapperClass + '" style="width:' + v + 'px; position:relative;"></div>').wrap('<div class="bx-window" style=" position:relative; overflow:hidden;"></div>').css({
                	width: "800px",
                    height: "500px",
                    position: "relative",
                    top: "-" + z + "px"
