...
class Home extends MX_Controller
{
	...
	public function index()
	{
		...
		$this->set_current_user();
                 ...
                 $records = $this->home_model->find("1");
                 $records2 = $this->home_model->find("2");
                 $marketing1 = $this->home_model->find("3");

		Template::set('records', $records);
                Template::set('records2', $records2);
                 Template::set('marketing1', $marketing1);
